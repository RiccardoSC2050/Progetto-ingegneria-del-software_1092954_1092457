# Progetto-ingegneria-del-software_1092954_1092457
...
# Descrizione del Progetto – Piano di Progetto (se necessario, MODIFICABILE)
...
Il progetto seguirà un **approccio Waterfall**, caratterizzato da una struttura **solida e sequenziale a step**, in cui ogni fase deve essere completata prima di procedere alla successiva.  

Saranno definite **milestone intermedie** per:
- monitorare i progressi,  
- verificare il raggiungimento degli obiettivi parziali,  
- garantire un flusso di lavoro produttivo e costante,  

fino alla **consegna finale del sistema**.  
...
Il progetto seguirà principi di **ingegneria del software** applicati allo sviluppo in **Java**, utilizzando **Maven** per la gestione delle dipendenze e della struttura del progetto.  
Saranno adottate regole chiare per:
- l’organizzazione dei pacchetti e delle classi;  
- la gestione delle dipendenze e dei moduli;  
- l’integrazione con il database e i relativi test;  
- la scrittura di codice leggibile e manutenibile.  

Per il **controllo di versione** si utilizzerà **GitHub**, con commit e push costanti da parte di entrambi i membri del team, garantendo tracciabilità e condivisione del lavoro.  

La **documentazione** sarà redatta in modo professionale, completa e ben strutturata, includendo:  
- documentazione tecnica per sviluppatori;  
- manuale utente per il personale dell’azienda;  
- aggiornamenti periodici per tracciare le modifiche e le versioni.  
...
## 8. Metodi e tecniche
Il progetto farà uso di metodi e tecniche consolidate di ingegneria del software:  

- **Ingegneria dei requisiti**: raccolta delle specifiche tramite incontri con il committente e formalizzazione dei requisiti con **diagrammi UML** (casi d’uso, attività).  
- **Progettazione**: modellazione dell’architettura del sistema con UML (diagrammi delle classi, di sequenza e dei componenti), per descrivere le interazioni tra i moduli.  
- **Implementazione**: sviluppo in **Java** con gestione delle dipendenze tramite **Maven** e controllo versione con **GitHub**, seguendo le linee guida di programmazione Java.  
- **Test**: realizzazione di **unit test** e **test di integrazione** tramite Maven, oltre a **test di accettazione** supervisionati dal committente.  
- **Manutenzione**: non è prevista manutenzione post-rilascio, in quanto il progetto si concluderà con la consegna finale.  
...
Il progetto non dispone di un **budget economico**, poiché si basa esclusivamente sul lavoro e sulle competenze del team.  

La **durata stimata** è di circa **1 mese**, ma la tempistica potrà estendersi a causa delle naturali limitazioni conoscitive legate all’apprendimento durante il corso.  

Il piano temporale sarà organizzato per **milestone settimanali**, con obiettivi precisi da raggiungere entro date quasi fisse, al fine di garantire un avanzamento costante e monitorabile.  

Esempi di milestone:  
- Settimana 1: Analisi requisiti e descrizione progetto  
- Settimana 2: Progettazione e UML  
- Settimana 3: Implementazione database e logica base  
- Settimana 4: Test, documentazione, interfaccia e consegna  
