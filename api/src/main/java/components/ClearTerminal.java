 ...
 * Provides functionality to clear the console screen using ANSI escape sequences.
 * 
...
public class ClearTerminal {
	 ...
	 * Uses escape sequence to move cursor to home position and clear display.
	 * Compatible with most modern terminals that support ANSI codes.
	 */
