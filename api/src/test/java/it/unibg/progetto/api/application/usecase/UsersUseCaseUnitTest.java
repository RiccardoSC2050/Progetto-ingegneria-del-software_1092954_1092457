...
class UsersUseCaseUnitTest {
    ...
    void numberOfAllOperators_countsNonNullUsers() {
        ...
        List<User> mapped = Arrays.asList(
                new User("id1", "u1", "pw", AccessLevel.AL1),
                null,
    ...
    void rootIsOnData_returnsRootDto_whenRootPresent() {
        ...
        User rootUser = new User(
                String.valueOf(InvalidValues.ROOTid.getLevel()),  // "0"
    ...
    void addRootOnData_buildsUsersEntityAndPersists() {
        ...
        when(rootMapper.toRootdtoFromRoot(eq("0"), eq("ROOT"), eq("pw"), eq(AccessLevel.AL5)))
                .thenReturn(rootDto);
    ...
    void printNameUserAll_doesNotThrow() {
        ...
        List<User> list = Arrays.asList(
                new User("1", "u1", "pw", AccessLevel.AL1),
    ...
    void trasformUserIntoUsersEntity_delegatesToUserMapper() {
        ...
        // non serve costruire un UserDto reale: basta far ritornare una entity Users finale
